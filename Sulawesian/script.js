...
// Carousel Logic
const carouselData = [
    { label: 'Coto Makassar', img: '../Content-Picture/CotoMakassar.png' },
    { label: 'Bubur Manado', img: '../Content-Picture/BuburManado.png' },
    { label: 'Pallubasa', img: '../Content-Picture/Pallubasa.png' }
];
